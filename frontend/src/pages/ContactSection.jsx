      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white p-10 shadow-sm max-w-[760px]">
            <h3 className="font-bebas text-lg uppercase tracking-wider mb-8">
              CONTACT FORM
            </h3>
          ...
          <div className="flex flex-col justify-center">
            <h2 className="font-bebas text-3xl md:text-4xl uppercase leading-tight">
            ...
            <div className="mt-6">
              <p className="font-bebas uppercase text-sm mb-3">Studio Locations</p>
