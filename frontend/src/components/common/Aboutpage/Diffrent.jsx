  ...
  return (
    <section className="bg-white">
            <div className="flex flex-col items-center justify-center text-center py-16 gap-4">
              <h2 className="text-xl font-semibold text-black font-bebas">WHAT sets us apart</h2>
              <h1 className="text-5xl font-bold text-black font-bebas">what makes ocd <span className="text-custom-red">different</span></h1>
            </div>
